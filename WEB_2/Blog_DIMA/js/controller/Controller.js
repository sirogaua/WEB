...
export default class Controller {
    constructor(itemListModel, itemListView, worker) {
        ...
        this.itemListView.setControllerOnAddComItem(this.addcom);
    ...
    onChangeCallback() {
        ...
        document.querySelector('#my-blog').innerHTML = this.itemListView.toHtml();
    }
    ...
    addcom(id) { 
        this.itemListModel.addcomment(id);
    }
